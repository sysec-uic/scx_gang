...
echo "  sudo apt install -y clang llvm libbpf-dev libelf-dev zlib1g-dev libzstd-dev bpftool \\"
...
echo "  git clone https://github.com/sched-ext/scx ~/scx"
echo "  # then run: SCX_DIR=~/scx bash scripts/10_build.sh"
